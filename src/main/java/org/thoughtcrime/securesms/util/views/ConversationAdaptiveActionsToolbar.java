...
/**
 * This class was pulled from Signal (AdaptiveActionsToolbar) and then adapted to the
 * ConversationActivity.
 */
public class ConversationAdaptiveActionsToolbar extends Toolbar {

  private static final int NAVIGATION_DP = 56;
  private static final int TITLE_DP =
      48; // estimated, only a number (if >1 items are selected there is more room anyway as there
  // are fewer options)
  ...
  public ConversationAdaptiveActionsToolbar(
    ...
    TypedArray array =
        context.obtainStyledAttributes(attrs, R.styleable.ConversationAdaptiveActionsToolbar);
